...
namespace SemanticLogging.LogglySink
{
    ...
    public static class LogglyLog
    {
        ...
        public static SinkSubscription<LogglySink> LogToLoggly(this IObservable<EventEntry> eventStream,
            string instanceName, string connectionString, string customerToken, string tag, TimeSpan? bufferingInterval = null,
        ...
        {
            var sink = new LogglySink(instanceName, connectionString, customerToken, tag,
        ...
        /// </returns>
        public static EventListener CreateListener(string instanceName, string connectionString, string customerToken, string tag,
            TimeSpan? bufferingInterval = null, TimeSpan? listenerDisposeTimeout = null, int maxBufferSize = Buffering.DefaultMaxBufferSize)
        {
            ...
            listener.LogToLoggly(instanceName, connectionString, customerToken, tag, bufferingInterval,
